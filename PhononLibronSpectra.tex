...
(Disclaimer: the positions of the complex conjugates here depend nontrivially on the definitions of the Fourier transform, and I'm not entirely certain if this should be the definition of $\bv C$ or its transpose) From here, the inverse of this matrix should give the coupling constant matrix!
