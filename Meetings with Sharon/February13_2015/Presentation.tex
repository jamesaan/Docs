...
\beq \mathcal{H} = \half{1}K_{\th\th} \sum_{\bv k \neq 0} \tilde \th^*_{\bv k} \tilde \th_{\bv k} = \half{1}K_{\th\th} \sum_{\bv k} \tilde \th^*_{\bv k} \tilde \th_{\bv k} - \half{1}K_{\th\th} \tilde \th^*_{0} \tilde \th_{0}. \eeq
